...
// the constants
   	...
   	int nx = 10 // 1 // 8 // 1 // 10 // 9 // 3 // 1   // number of electrodes along X-axis
   	int ny = 5 // 1 // 8 // 1 // 10 // 9 // 3 // 1   // number of electrodes along Y-axis
   	int number_electrodes = {nx * ny}
   	float dx = 17.3e-6 // 40e-6 // 50e-6 // 0  // interelectrode spacing
   	float dy = 17.3e-6 // 40e-6 // 50e-6 // 0 

// electrode array now centered at excitatory neuron

//   	float ox = - {4 * {dx} + {dx / 2}} // 20e-6 // -140e-6 // 20e-6 // 0 // -225e-6 // -50e-6 // 20e-6 // 0 
   	float ox = - {4 * {dx} + {dx / 2}} - 0.00004 // 20e-6 // -140e-6 // 20e-6 // 0 // -225e-6 // -50e-6 // 20e-6 // 0 
   	float oy = - 2 * {dy} // 20e-6 // -140e-6 // 20e-6 // 0 // -225e-6 // -50e-6 // 20e-6 // 0

	int number_contact_points = 12 // 8 // 11 // 1 // 11
   	float contact_separation = 60e-6 // 0.1e-3 // 0.15e-3 // 0.6e-3
