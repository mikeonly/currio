...
include ../L5P37C-onlybasal/Axon_comps.g
...
// include L5P_synchan.g // already included in main script
	...
	float attenuation_factor = 0.3 // 0.1 //  0 // 0.3 // 0.05 // 0.1 // 0.3 // 0.4
...
// when len != 0 the compartment is considered cylindrical
	surf = {dia * dia * PI}
   	...
   	setfield soma/NaF Gbar {GNaF_s * surf * 1}
   	...
   	setfield soma/KDr Gbar {GKDr_s * surf * 5}
   	...
   	setfield soma/KC Gbar {GKC_s * surf * 5}
...
//   setfield Dend_Ap_Shaft/NaF Gbar {GNaF_shaft * surf}
   	...
   	setfield Dend_Ap_Shaft/KDr Gbar {GKDr_shaft * surf}
   	...
   	setfield Dend_Ap_Shaft/CaL Gbar {GCaL_shaft * surf}
...
*/
	...
	surf = {dia * len * PI}
   	...
   	setfield Dend_Ap/CaL Gbar {GCaL_pad * surf}
...
*/
	...
	surf = {dia * len * PI}
   	...
   	setfield Dend_Ap_Med/CaT Gbar {GCaT_mad * surf}
   	...
   	setfield Dend_Ap_Med/CaL Gbar {GCaL_mad * surf * attenuation_factor}
...
*/
	...
	surf = {dia * len * PI}
   	...
   	setfield Dend_Ap_Obl/NaF Gbar {GNaF_pad * surf * attenuation_factor * 0.5}
   	...
   	setfield Dend_Ap_Obl/NaP Gbar {GNaP_pad * surf * attenuation_factor * 0.5}
   	...
   	setfield Dend_Ap_Obl/CaT Gbar {GCaT_pad * surf * attenuation_factor * 0.5}
   	...
   	setfield Dend_Ap_Obl/CaL Gbar {GCaL_pad * surf}
...
*/
	...
	surf = {dia * len * PI}
   	...
   	setfield Dend_Ap_Dis/CaT Gbar {GCaT_dd * surf}
   	...
   	setfield Dend_Ap_Dis/CaL Gbar {GCaL_dd * surf}
