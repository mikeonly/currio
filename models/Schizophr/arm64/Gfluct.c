...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 1, "pntproc");
 	...
 	ivoc_help("help ?1 Gfluct2 /Users/mf/Documents/Helmholtz Institue Mainz 2/Neuron/Schizophr/Gfluct.mod\n");
...
{
 { error =  oup();
 if(error){fprintf(stderr,"at line 151 in file Gfluct.mod:\n	SOLVE oup\n"); nrn_complain(_p); abort_run(error);}
 }}}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/Users/mf/Documents/Helmholtz Institue Mainz 2/Neuron/Schizophr/Gfluct.mod";
static const char* nmodl_file_text = 
